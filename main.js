...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = '';
        var titles = ['Super firmy online', 'Awesome Vines', 'YouTube 2.0'];
        this.title = titles[Math.floor(Math.random() * 100) % titles.length];
    }
...
module.exports = __webpack_require__(/*! /Everyday/Programowanie/Prywatne/playground/js/angular/warsawjs-workshop-29-movies/src/main.ts */"./src/main.ts");
